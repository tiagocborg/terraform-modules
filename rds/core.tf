...
resource "aws_secretsmanager_secret_version" "secret_val" {
  ...
  secret_string = "{\"DB_USER\":\"${var.db_user}\",\"DB_PASSWORD\":\"${random_password.random_string.result}\",\"DB_HOST\":\"${aws_db_instance.this.endpoint}\",\"DB_PORT\":\"${aws_db_instance.this.db_port}\"}"
}
